...
#' \code{\link{pq_data_dir}} shows or resolves the default 'Parquet'
#' repository location. 'WRDS' helpers resolve usernames from explicit
#' arguments, `WRDS_ID`, `WRDS_USER`, and then the credential store used by the
#' `wrds` package.
#'
#' @keywords internal
"_PACKAGE"
